...
<ul class="nav nav-pills nav-stacked">
  ...
  <li role="presentation" class="active"><a href="${url}?q=Links">Links</a></li>
  <li role="presentation"><a href="${url}?q=UpVotes">UpVotes</a></li>
</ul></div>
<div class="col-sm-9">
        <c:if test="${empty profile.links}">
            <h1>This user has not posted any links yet</h1>
        </c:if>
        <c:forEach items="${profile.links}" var="link">
